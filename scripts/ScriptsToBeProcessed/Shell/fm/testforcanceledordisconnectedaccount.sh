...
values(8, 1025, 'RUB2SL6','','','','Default',1,4,0,0,0,0,0,0,sysdate,sysdate,0,0,0,null,'34523456','3497581','+191456789','1234564','2345678');

insert into subscriber_phone_number (subscriber_ID, PHONE_NUMBER , IMSI_NUMBER, EQUIPMENT_ID, CONNECTION_TYPE, SERVICES,
PHONE_NUMBER_STATUS) values(1025,'+9152743423', '','',1,1024,1);
