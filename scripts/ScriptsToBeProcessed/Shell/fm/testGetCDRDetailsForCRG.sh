...
insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,
	duration,caller_number,called_number, call_type,subscriber_id,
		...
		values(1051,1, 1, 1, 1, 0,1,to_date('09:01:2005 08:30:00','dd:mm:yyyy hh24:mi:ss'),
				230,'+919820535200','+119820535201',3,1025,300,1,
				'+919820535200', 9, 0) ;

insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,
	duration,caller_number,called_number, call_type,subscriber_id,
		value,cdr_type,phone_number,day_of_year, hour_of_day) 
		values(1052,1, 1, 1, 1, 0,1,to_date('08:01:2005 21:00:00','dd:mm:yyyy hh24:mi:ss'),
...
insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number,
                ...
                values(1055,1, 1, 1, 1, 0,1,to_date('08:01:2005 03:00:00','dd:mm:yyyy hh24:mi:ss'),
                                230,'+919820535202','+919820535203',1,1027,300,1,
                                '+919820535202', 8, 0) ;
...
insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number,
                ...
                values(1056,1, 1, 1, 1, 0,1,to_date('09:01:2005 10:00:00','dd:mm:yyyy hh24:mi:ss'),
                                230,'+919820535202','+44820535203',3,1027,300,1,
                                '+919820535202',9,0) ;

insert into subscr_neural_voice_profile (subscriber_id, phone_number, network_id, sequence_id, profile_type, profile_matured)
        values(4, '+918845200001', 1, 0, 2, 1) ;

insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number, call_type,subscriber_id, value,cdr_type,phone_number,day_of_year, hour_of_day) 
	values(1070,1024, 1, 1, 1, 0,1,to_date('08:01:2005','dd:mm:yyyy'), 230,'+918845200001','+19820535213',3,4,300,1, '+918845200001',8, 0) ;

insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number, call_type,subscriber_id, value,cdr_type,phone_number,day_of_year, hour_of_day) 
	values(1070,1024, 2, 1, 1, 0,1,to_date('08:01:2005','dd:mm:yyyy'), 0,'+918845200001','+19820535213',3,4,1,1, '+918845200001',8, 0) ;

insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number, call_type,subscriber_id, value,cdr_type,phone_number,day_of_year, hour_of_day) 
	values(1071,1024, 1, 1, 1, 0,2,to_date('08:01:2005','dd:mm:yyyy'), 235,'+919820535213','+918845200001',1,4,301,1, '+918845200001',8, 0) ;

insert into cdr (id,network_id, service_type, cdr_category, is_complete, is_attempted,record_type,time_stamp,duration,caller_number,called_number, call_type,subscriber_id, value,cdr_type,phone_number,day_of_year, hour_of_day) 
	values(1072,1024, 1, 1, 1, 0,1,to_date('08:01:2005','dd:mm:yyyy'), 225,'+918845200001','+919820535213',1,4,299,1, '+918845200001',8, 0) ;
