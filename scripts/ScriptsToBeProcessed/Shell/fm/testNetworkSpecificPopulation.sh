...
---- SUBSCRIBER 2
insert into account (id, account_type, account_name, account_doa, network_id, first_name, middle_name, last_name, address_line_1, address_line_2, address_line_3, city, post_code, frd_indicator) values (1026, 0, '18101961', to_date('', 'dd/mm/yyyy'),1024, 'manu' ,'m' ,'kuman' ,'' ,'' ,'' ,'' ,'', 0) ;

insert into subscriber(id, subscriber_type, account_id, account_name, phone_number, subscriber_doa, home_phone_number, office_phone_number, contact_phone_number, mcn1, mcn2, imsi, imei, connection_type, groups, services, status, qos, product_type, network_id) values (1026, 0, 1026, '18101961',  '+919820535201', sysdate -11,'' ,'' ,'' ,'' ,'' ,'404209820535200' ,'' ,'1' ,'pvn, aigrp1' ,2047, 1,0, 1, 1024) ;
