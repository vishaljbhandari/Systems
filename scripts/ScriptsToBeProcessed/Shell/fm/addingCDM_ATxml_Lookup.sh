...
--ACCOUNT
insert into table_dfn(tbd_id,sct_id,tbd_name,tbd_prefix,tbd_system_fl,TBD_INTERNAL_FL,TBD_TEMP_FL,TBD_HYBRID_FL,tbd_delete_fl,tbd_version_id,ptn_id )
            values(1252,1,'ACCOUNT','ACCOUNT','N','N','N','N','N',1,1
            );
...
insert into table_dfn(tbd_id,sct_id,tbd_name,tbd_prefix,tbd_system_fl,TBD_INTERNAL_FL,TBD_TEMP_FL,tbd_delete_fl,TBD_HYBRID_FL,tbd_version_id,ptn_id )
            values(1258,1,'NIK_SUBSCRIBER','NIK_SUBSCRIBER','N','N','N','N','N',1,1
            );
...
insert into table_dfn
        (tbd_id,sct_id,tbd_name,tbd_prefix,tbd_system_fl,TBD_INTERNAL_FL,TBD_TEMP_FL,tbd_delete_fl,TBD_HYBRID_FL,tbd_version_id,ptn_id )
         values(1259,1,'UNF_CONVERSION','UNF_CONVERSION','N','N','N','N','N',1,1
        );
...
----COUNTRY CODE change
INSERT INTO 
TABLE_DFN(TBD_ID,SCT_ID,TBD_NAME,TBD_PREFIX,TBD_SYSTEM_FL,TBD_INTERNAL_FL,TBD_TEMP_FL,TBD_HYBRID_FL,TBD_DELETE_FL,TBD_VERSION_ID,PTN_ID )
	VALUES(1265,1,'CDM_COUNTRY_CODES','CDM_COUNTRY_CODES','N','N','N','N','N',1,1);
INSERT INTO
	TABLE_INST(TIN_ID,TBD_ID,SCH_ID,TIN_TABLE_NAME,TIN_DISPLAY_NAME,TIN_ALIAS,TIN_DELETE_FL,TIN_VERSION_ID,PTN_ID)
	 VALUES(1265,1265, 1,'CDM_COUNTRY_CODES','CDM_COUNTRY_CODES','CDM_COUNTRY_CODES','N',1,1);
INSERT INTO
	...
	VALUES(12120,1265,'ID','ID',1,'Y','int',0,'Y','N',1,1);
INSERT INTO
	TABLE_COLUMN(TCL_ID,TBD_ID,TCL_NAME,TCL_DISPLAY,TCL_ORDER_NO,TCL_PRIMARY_KEY_FL,TCL_TYPE,TCL_LENGTH,TCL_MANDATORY_FL,TCL_DELETE_FL,TCL_VERSION_ID,PTN_ID)
	VALUES(12121,1265,'CODE','CODE',2,'N','string',20,'Y','N',1,1);

create or replace synonym CDM_COUNTRY_CODES for $DB_USER.CDM_COUNTRY_CODES@$NIKIRA_DB_LINK;
