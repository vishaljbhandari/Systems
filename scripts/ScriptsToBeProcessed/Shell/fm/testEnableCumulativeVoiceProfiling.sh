...
update configurations set value = 0 where config_key in ('AI.ENABLE_SINGLE_VOICE_PROFILE', 'AI.ENABLE_CUMULATIVE_DATA_PROFILE',
												'AI.ENABLE_ROC_VOICE_PROFILE', 'AI.ENABLE_ROC_DATA_PROFILE') ;
