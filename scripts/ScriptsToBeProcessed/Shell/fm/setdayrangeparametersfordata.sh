...
delete from configurations where config_key = 'LAST_GPRS_CDR_TIME1' ;
...
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'LAST_GPRS_CDR_TIME0', '$2') ;
insert into configurations(id, config_key) values(configurations_seq.nextval, 'LAST_GPRS_CDR_TIME1') ;
