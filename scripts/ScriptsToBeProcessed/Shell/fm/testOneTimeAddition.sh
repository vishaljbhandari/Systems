...
update configurations set value = 1 where config_key in 
	('AI.ENABLE_CUMULATIVE_VOICE_PROFILE', 'AI.ENABLE_CUMULATIVE_DATA_PROFILE', 'AI.ENABLE_ROC_VOICE_PROFILE', 'AI.ENABLE_ROC_DATA_PROFILE' ) ;
...
insert into subscriber(id, subscriber_type, account_id, account_name, phone_number, subscriber_doa, home_phone_number, office_phone_number, contact_phone_number, mcn1, mcn2, imsi, imei, connection_type, groups, services, status, qos, product_type, network_id) values (1026, 0, 1026,'18101961',  '+919820535201', sysdate -11,'' ,'' ,'' ,'' ,'' ,'404209820535200' ,'' ,'1' ,'pvn, aigrp1' ,2047, 1,0, 1, 1) ;

--SubscriberLess Scenario --
insert into subscriber(id, subscriber_type, account_id, account_name, phone_number, subscriber_doa, home_phone_number, office_phone_number, contact_phone_number, mcn1, mcn2, imsi, imei, connection_type, groups, services, status, qos, product_type, network_id) values (1027, 0, 4, '', '+918845200001', sysdate -11,'' ,'','' ,'' ,'' ,'404209820535200' ,'' ,'1' ,'pvn, Subscriberless' ,2047, 1,0, 1, 1024) ;

insert into subscriber(id, subscriber_type, account_id, account_name, phone_number, subscriber_doa, home_phone_number, office_phone_number, contact_phone_number, mcn1, mcn2, imsi, imei, connection_type, groups, services, status, qos, product_type, network_id) values (1028, 0, 4, '', '+918845200002', sysdate -11,'' ,'','' ,'' ,'' ,'404209820535200' ,'' ,'1' ,'pvn, Subscriberless' ,2047, 1,0, 1, 1024) ;

insert into subscr_neural_voice_profile values(1028, '+918845200002', 0, 1024, 2, 1, '0:0','2', '', '', '') ;
